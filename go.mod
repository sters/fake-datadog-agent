module github.com/sters/fake-datadog-agent

go 1.17

replace github.com/iovisor/gobpf => github.com/iovisor/gobpf v0.2.0
...
require github.com/DataDog/datadog-agent v0.0.0-20210913210003-1f013d7aad22
